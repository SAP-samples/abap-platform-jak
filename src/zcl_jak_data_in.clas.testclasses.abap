...
CLASS ltcl_jak_data_in IMPLEMENTATION.
  ...
  METHOD issue_2.
    ...
    TYPES: BEGIN OF ty_addr,
           ...
           BEGIN OF ty_adadr,
             addr TYPE ty_addr,
             ntr  TYPE STANDARD TABLE OF string WITH NON-UNIQUE KEY table_line,
           END OF ty_adadr,
           BEGIN OF ty_something,
             stj_cd TYPE string,
             lgnm   TYPE string,
             nba    TYPE STANDARD TABLE OF string WITH NON-UNIQUE KEY table_line,
             adadr  TYPE STANDARD TABLE OF ty_adadr WITH NON-UNIQUE KEY table_line,
             pradr  TYPE ty_adadr,
           END OF ty_something.
